...
shinyUI(navbarPage( 
 ...
 # theme = shinytheme("slate"),
      shinythemes::themeSelector(),
          ##------------------------------------------------------------------------------------------------------------------------------##
          tabPanel("Apercu gÃ©nÃ©ral sur les SVM",
                    # mainPanel(column(12, #offset = 2, includeMarkdown("./resume.rmd"))   
                                        ...
                                        mainPanel( 
                                          tabsetPanel( 
                                            ...
                                            tabPanel("HypothÃ¨se1",includeMarkdown("./idee1.rmd")),  
                                            tabPanel("HypothÃ¨se2",includeMarkdown("./idee2.rmd")), 
                                            tabPanel("HypothÃ¨se3",includeMarkdown("./Idee3.rmd")) 
               ...
               title= "Exploration",  
                     sidebarLayout(  
                                sidebarPanel(   
                                    ...
                                    sliderInput("d",label= "Variables Ã  reprÃ©senter :Derouler", value=9,min=1,max=22), 
                      ...
                      mainPanel( 
                            ...
                            tabPanel(p(icon("table"),"CorrÃ©lations "),includeMarkdown("./correlation.rmd"),tableOutput("corr")), 
             ...
             title = "ModÃ©lisation",  
                  sidebarLayout(  
                       sidebarPanel(width = 3,  
                            ...
                            sliderInput("degree",label= "ParamÃ¨tre du noyau polynomiale:", value=2,min=1,max=3), 
                            sliderInput("coef",label= "CoÃ»t de pÃ©nalisation du kernel", value=1,min=0,max=3), 
                            selectInput(inputId="mins", label="Minimum d'arbres:", choices=c(2,4,6,8,10,12), selected = 6, multiple = FALSE,
                                        selectize = TRUE, width = NULL, size = NULL),
                            numericInput(inputId="cp", label="coÃ»t de complexiter de l'arbre:", value=0.00001, min = 0.000001, max = 0.0001, step = 0.00002,width = NULL)
                            ), 
      
                   #Modelisation:Modelisation 
                  mainPanel( 
                       tabsetPanel( 
                           tabPanel(p(icon("area-chart"),"ModÃ©lisation"),  
                               fluidRow(h3( align=h3.align)),
                                       ...
                                       fluidRow( 
                                            ...
                                            column(5, h4("Proportion de fraudes dans chaque Ã©chantillon.", align="center"),
                          ...
                          tabPanel(p(icon("table"),"SÃ©lÃ©ction"),  
                              fluidRow(h3( align=h3.align)),
                                       fluidRow(
                                       ...
                                       fluidRow( 
                                           column(7, h3("ProbabilitÃ©s prÃ©dites par noyau.", align="center"),
                                                h6("1 ProbabilitÃ© que la transaction soit frauduleuse, 0 si elle est  non frauduleuse."), 
                                                column(7,offset=-1,DT::dataTableOutput("prob"))),
                       
                                            column(4, h4("Taux d'erreur de validation.", align="center"),
                                                h6("Les taux ont Ã©tÃ© Ã©valuÃ© sur l'Ã©chantillon de validation.") ,
                             ...
                             fluidRow(h3("Performance comparative des noyaux kernels.", align=h3.align)),
                                      fluidRow(
                                           column(7, h4("Anlayse par les courbes ROC", align="center"),
                                               h6("Le meileur kernel est celui ayant la ROC la plus extrÃªme possible.", align="center"),
                                               plotOutput("perform")
                                                  ),
                                           column(4, h4("Analyse  quantitative des courbes ROC: AUC", align="center"),
                                               h6("La performace maximale possible correspond Ã  un AUC de 1.", align="center"),
                         ...
                         #Modelisation: benchmark 
                          tabPanel(p(icon("list-alt"),"Benchmark du svm"),   
                              tabsetPanel( 
                                tabPanel(p(icon("table"),"Arbres de dÃ©cision"),
                                       fluidRow(h3( align=h3.align)),
                                          fluidRow(
                                              column(11, h4( align="center"),
                                                 includeMarkdown("")),
                                          ...
                                          fluidRow( 
                                              column(11, h3("Arbre de dÃ©cision", align="center"),
                                                 h6("Les noeuds terminaux permettement de trouver la prÃ©diction des transactions:fraude ou non."), 
                                                 column(11,offset= 2,plotOutput("arbre"))), 
                                              
                                              column(11, h4("MÃ©sure d'importance des variables", align="center"),
                                                        h6("Un nombre rÃ©duit  de variables devrait Ãªtre utilisÃ©") ,
                                                        column(11,offset = 2, plotlyOutput("importance"))),
                                      
                                              column(7, h4("Arbre brute vs arbre optimisÃ©", align="center"),
                                                 ...
                                                 fluidRow(
                                                  ...
                                                  fluidRow( 
                                                     column(11, h3("Performance du Gradient boosting ", align="center"),
                                                           h6("Nous ne prÃ©sentons ici que les rÃ©sultats en terme de performance de l'algorithme."), 
